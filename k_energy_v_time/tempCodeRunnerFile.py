...
def main():
    ...
    output_file_name = "k_energy_test.png"
    ...
    fig.text(0.5, 0.02, 'Time (fs)', ha='center', va='center', fontsize=24, fontweight='bold', fontname='Times New Roman')
    fig.text(0.09, 0.5, 'Kinetic Energy (eV)', ha='center', va='center', rotation='vertical', fontsize=24, fontweight='bold', fontname='Times New Roman')
